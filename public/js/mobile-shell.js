(function () {
  ...
  if (!document.getElementById('mobile-shell-css')) {
    ...
    style.textContent = [
      ...
      '  }',
      '  /* About page: team-member cards keep avatar + name horizontally aligned */',
      '  .grid.grid-cols-2.sm\\:grid-cols-3>.flex.items-center.gap-3{',
      '    flex-wrap:nowrap!important;',
      '  }',
      '  header.h-16{',
      ...
      '  }',
      '  header.h-16 .mobile-header-meta{',
      '    display:flex!important;align-items:center;',
      '    font-size:13px;font-weight:600;color:#64748b;',
      '    white-space:nowrap;overflow:hidden;text-overflow:ellipsis;',
      '    max-width:120px;flex:0 0 auto!important;',
      '    margin-left:auto;',
      '  }',
      '  /* ---- Logo in header ---- */',
      '  .mobile-header-logo{',
      ...
      '    display:flex!important;',
      '  }',
      '  /* ---- Footer visible on Android: override h-screen with dynamic viewport ---- */',
      '  .h-screen{',
      ...
      '  footer{',
      '    padding:20px 16px max(24px, env(safe-area-inset-bottom, 24px))!important;',
      '    text-align:center!important;',
      '  }',
      '  /* Row 1: description + links → stack vertically */',
      ...
      '  }',
      '  /* Row 2: copyright + disclaimer → stack centered */',
  ...
  function init() {
    ...
    // ---- Inject logo in header (hidden on small mobile via CSS) ----
